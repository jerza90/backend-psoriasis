...
import { Mail, Key, User, Lock, ArrowLeft, Check, Send } from 'lucide-react';
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-sm glass-card rounded-2xl p-8 animate-fade-up">
          ...
          <form onSubmit={handleVerify} className="flex flex-col gap-4">
            ...
            <div>
              <label className="text-sm font-semibold mb-1.5 block">{t('auth.fullName')}</label>
            ...
            <div>
              <label className="text-sm font-semibold mb-1.5 block">{t('auth.username')} <span className="text-muted font-normal">({t('auth.optional')})</span></label>
              <div className="relative">
                <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted" />
                <input
                  type="text"
